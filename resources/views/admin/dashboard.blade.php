...
<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="mt-5">
                    <div class="bg-heavygreen border border-3 border-success p-4 mt-5 rounded-2">
                        <div>
                            <h1 class="font_150 text-lightwhite">Usuários</h1><hr>
                            <span class="text-lightwhite text_100">Abra a lista de <strong>USUÁRIOS</strong> existentes no Sistema.</span>
                        </div>
                        <a class="mt-4 btn btn-success" href="{{ route('admin.users.index') }}">Entrar</a>
                    </div>
    
                    <div class="bg-heavyblue border border-3 border-primary p-4 mt-5 rounded-2">
                        <div>
                            <h1 class="font_150 text-lightwhite">Gerência</h1><hr>
                            <span class="text-lightwhite text_100">Desculpe, esta área está <strong>desativada</strong> no momento!</span>
                        </div>
                        <a class="mt-4 btn btn-primary disabled">Entrar</a>
                    </div>
                </div>
            </div>
        </div>
