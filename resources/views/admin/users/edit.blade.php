    ...
    <div class="container mx-auto mt-5">
        <div class="dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg p-5">
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                    ...
                    <div class="col">
                        ...
                        <label for="user_class" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Categoria</label>
                            <select name="user_class" id="user_class" class="bg-inputblue text-white rounded block mt-1 w-full">
                                ...
                                <option value="suporte" {{ $user->user_class == 'suporte' ? 'selected' : '' }}>Suporte Técnico</option>
                                <option value="financeiro" {{ $user->user_class == 'financeiro' ? 'selected' : '' }}>Financeiro</option>
                            </select>
                        @error('user_class')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                ...
                <div class="mt-5 mb-2">
                    <h2 class="text-center font_110 text-white">Informações Pessoais</h2>
                </div>
