...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Política de Privacidade - Edu Sustentável') }}
        </h2>
    </x-slot>
    ...
    <div class="container mx-auto mt-5 p-4">
        ...
        <p>O <strong>Edu Sustentável</strong> coleta informações pessoais que você nos fornece ao se registrar, tais como nome, e-mail, número de telefone, endereço e dados de pagamento. Essas informações são necessárias para oferecer uma experiência segura e personalizada em nossa plataforma.</p>
        ...
        <p>O <strong>Edu Sustentável</strong> valoriza sua privacidade e não compartilha suas informações pessoais com terceiros, exceto quando necessário para:</p>
        <ul>
            ...
            <li>Proteger a segurança e os direitos da Edu Sustentável, de seus usuários e de terceiros, conforme permitido ou exigido por lei.</li>
        </ul>

        <h3 class="font-semibold text-lg text-gray-800">4. Segurança das Informações</h3>
        <p>O <strong>Edu Sustentável</strong> adota medidas técnicas e organizacionais para proteger suas informações contra acessos não autorizados, perda, alteração ou divulgação. No entanto, nenhum sistema é completamente seguro e garantimos nosso esforço contínuo para proteger seus dados.</p>
        ...
        <p>Você tem o direito de acessar, corrigir, ou solicitar a exclusão de suas informações pessoais armazenadas no <strong>Edu Sustentável</strong>. Para exercer esses direitos, entre em contato conosco através dos canais de atendimento disponíveis.</p>
        ...
        <p>O <strong>Edu Sustentável</strong> reserva-se o direito de atualizar esta Política de Privacidade periodicamente. Notificaremos as alterações na plataforma, e o uso contínuo após a atualização indica sua aceitação dos novos termos.</p>

        <h3 class="font-semibold text-lg text-gray-800">9. Contato</h3>
        <p>Se tiver dúvidas ou preocupações sobre nossa Política de Privacidade, entre em contato com o suporte do <strong>Edu Sustentável</strong> pelo nosso canal de atendimento.</p>
